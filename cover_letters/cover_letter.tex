...
% Company Info
%====================
\def\firstname{Michelle}
\def\lastname{Liu}
\def\nameunknown{Hiring Manager}
\def\hm{\nameunknown} % Hiring Manager Name, leave empty if unknown

\def\hremail{hremail@email.com}
\def\position{Recruiter, Software Engineering Institue} % position
\def\company{MIT Lincoln Labs} % company
...
\def\targetpos{Secure Software and Embedded Systems Engineer}
