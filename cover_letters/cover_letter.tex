...
\def\firstname{Bill}
\def\lastname{Scully}
\def\hm{\firstname\ \lastname} % Hiring Manager Name, leave empty if unknown

\def\hremail{wsscully@sei.cmu.edu}
\def\position{Recruiter, Software Engineering Institue} % position
\def\company{the Software Engineering Institute at Carnegie Mellon University} % company
%\def\source{on LinkedIn} % where was the posting found, "I found ____ "
\def\targetpos{Assistant AI Security Researcher}
